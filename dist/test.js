...
try {
    ...
    await mcpClient.connect(new StreamableHTTPClientTransport(new URL(SERVER_URL)));
    ...
    for (const [question, mustContain] of qaTests) {
        ...
        const tq = rq.content[0].text.toLowerCase();
